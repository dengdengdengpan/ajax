...
Ajax.prototype.judgeReqMethod = function () {
    let xhr = this.xhr,
        param = this.getReqParams(this.data),
...
LoadMore.prototype.init = function () {
    this.list = this.target.querySelector('.list');
    this.loadMoreBtn = this.target.querySelector('.loadmore');
...
LoadMore.prototype.loadRespData = function () {
    let ajax = new Ajax({
        method: 'get',
        url: '/loadMore',
        data: {
